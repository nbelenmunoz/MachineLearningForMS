...
def gpt_image(query='', image_path='', temperature=0.7, max_tokens=500):
...
def main():
    ...
    if mode == 'I':
        query_text = input('Optional image description:\nAdd an optional description of the part’s features (holes, slots, surfaces, tolerances), or just leave it blank: ')
        try:
        ...
        part_desc = gpt_image(query_text, image_filename)
